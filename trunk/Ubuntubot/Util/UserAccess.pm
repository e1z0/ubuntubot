package Ubuntubot::Util::UserAccess;
...
# The levels are used throught other parts of the program. Bot sees what level he possesses by comparing the hostmask to a database.
